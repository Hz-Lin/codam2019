...
/*                                                   +#+                      */
/*   Created: 2022/04/27 18:59:21 by hlin          #+#    #+#                 */
/*   Updated: 2022/04/27 20:56:44 by hlin          ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(const ScavTrap &original) : ClapTrap(original) {
	std::cout << "ScavTrap " << original._name << " has been cloned" << std::endl;
}
...
// overwrite the attack fuction in parent class
